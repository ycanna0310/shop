...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/admin?method=adminProduct','','mainFrame');
		d.add('0106','01','订单管理');
		//d.add('010601','0106','订单管理','${pageContext.request.contextPath}/admin/order/list.jsp','','mainFrame');
		d.add('010601','0106','订单管理','${pageContext.request.contextPath}/admin?method=findAllOrders','','mainFrame');
		document.write(d);

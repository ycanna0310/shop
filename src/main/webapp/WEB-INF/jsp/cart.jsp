		...
		<div class="container">
						...
						<tbody>
							...
							<c:forEach items="${cart.map }" var="entry">
								<tr class="active">
									...
									<td>
										<a href="${pageContext.request.contextPath }/product/deleteCartItem.action?pid=${entry.key}" class="delete">删除</a>
									</td>
								</tr>
							</c:forEach>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath }/product/clearCart.action" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath }/product/submitOrder.action">

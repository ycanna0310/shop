			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product.marketPrice }元/份</strong> 参 考 价：
					...
					<div style="padding: 10px; border: 1px solid #e7dbb1; width: 330px; margin: 15px 0 10px 0;; background-color: #fffee6;">
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:void(0);" onclick="addProductToCart()"> 
					...
					<div>
						<a href="${pageContext.request.contextPath}/product/productListByCid.action?cid=${cid}&currentPage=${currentPage}" style="font-size:25px;">
							返回列表页面
						</a>
					</div>
...
<script>
	function addProductToCart(){
		...
		window.location.href="${pageContext.request.contextPath}/product/addProductToCart.action?pid=${product.pid}&buyNum="+buyNum;
	}
</script>
</html>